  ...
  run: [
    // nvidia windows 
    {
      ...
      "params": {
        ...
        "message": [
          "uv pip install torch==2.8.0 torchvision==0.23.0 torchaudio==2.8.0 {{args && args.xformers ? 'xformers==0.0.32' : ''}} --index-url https://download.pytorch.org/whl/cu128 --force-reinstall --no-deps",
    ...
    // nvidia linux
    {
      ...
      "params": {
        ...
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": [
          "uv pip install torch==2.8.0 torchvision==0.23.0 torchaudio==2.8.0 {{args && args.xformers ? 'xformers==0.0.32' : ''}} --index-url https://download.pytorch.org/whl/cu128 --force-reinstall",
